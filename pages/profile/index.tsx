      ...
      <div className="py-10 px-4">
        ...
        <div className="mt-10 flex justify-around">
          <div className="flex flex-col items-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-center text-white">
              <svg
                className="h-6 w-6"
                fill="none"
                stroke="currentColor"
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 font-medium text-gray-700">구매내역</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-orange-500 text-center text-white">
              <svg
            ...
            <span className="mt-2 font-medium text-gray-700">관심목록</span>
          </div>
        </div>
        <div className="mt-12">
          <div className="flex items-center space-x-3">
