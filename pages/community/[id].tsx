function CommunityPostDetail() {
  return (
    <div>
      ...
      <div className=" mb-3 flex items-center space-x-3 border-b py-3">
      ...
      <div></div>
      <span className="mt-2 ml-4 text-gray-700">
      ...
      <div className="my-5 space-y-5 px-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <span className="block text-sm text-gray-500">2시간 전</span>
