      ...
      <div className="mt-8">
        ...
        <div className="mt-8">
          <div className="relative">
            <div className="borer-gray-300 absolute w-full border-t" />
            <div className="relative -top-3 text-center font-medium">
              <span className="bg-white px-2 text-gray-500">Or enter with</span>
            </div>
          </div>
          <div className="mt-2 grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center rounded-md border border-gray-300 bg-white py-2 px-4 font-medium text-gray-400 shadow-sm hover:bg-gray-500">
              <svg
                className="h-5 w-5"
                aria-hidden="true"
                fill="currentColor"
